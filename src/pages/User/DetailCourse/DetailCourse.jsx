...
import playPauseIcon from "../../../assets/play-pause.png";
import pauseToPlayIcon from "../../../assets/pause-to-play.svg";
import replayIcon from "../../../assets/replay_10_24px.svg";
import forwardIcon from "../../../assets/forward_10_24px.svg";
import fullscreenIcon from "../../../assets/fullscreen_24px.svg";
import volumeIcon from "../../../assets/Volume.svg";
import hdIcon from "../../../assets/hd_24px.svg";
import groupIcon from "../../../assets/Group.svg";
import closedCaptionIcon from "../../../assets/closed_caption_24px.svg";
            ...
            <div className={styles["detail-course-content"]}>
                ...
                <div className={styles["course-card-detail"]}>
                    ...
                    <div className={styles["course-left"]}>
                        <DetailCourseProvider value={{ onPlayVideo: setCurrentVideo }}>
                            <div className={styles["video-container"]}>
                                ...
                                {/* Center Play Button */}
                                <div
                                    className={`${styles["center-play-container"]} ${isPurchased ? styles["purchased"] : ""}`}
                                >
                                    <img
                                        src={playPauseIcon}
                                        alt="Play"
                                        className={styles["center-play-icon"]}
                                        onClick={handlePlayPause}
                                    />
                                </div>

                                {/* Video Footer Controls */}
                                <div className={`${styles["video-footer"]} ${isPurchased ? styles["purchased"] : ""}`}>
                                    <div className={styles["progress-bar-container"]}>
                                        <div className={styles["progress-bar-filled"]}></div>
                                    </div>
                                    ...
                                    <div className={styles["controls-row"]}>
                                        <div className={styles["left-controls"]}>
                                            <img
                                                ...
                                                onClick={handlePlayPause}
                                            />
                                            <img src={replayIcon} alt="Replay 10s" className={styles["control-icon"]} />
                                            <img
                                                src={forwardIcon}
                                                alt="Forward 10s"
                                                className={styles["control-icon"]}
                                            />
                                            <img src={volumeIcon} alt="Volume" className={styles["control-icon"]} />
                                            <span className={styles["time-display"]}>00:00 / 12:30</span>
                                        </div>

                                        <div className={styles["right-controls"]}>
                                            <img src={hdIcon} alt="HD" className={styles["control-icon"]} />
                                            <img src={closedCaptionIcon} alt="CC" className={styles["control-icon"]} />
                                            <img src={groupIcon} alt="Settings" className={styles["control-icon"]} />
                                            <img
                                                src={fullscreenIcon}
                                                alt="Fullscreen"
                                                className={styles["control-icon"]}
                    ...
                    <div
                        className={`${styles["course-right"]} ${isPurchased ? styles["course-right-purchased"] : styles["course-right-unpurchased"]}`}
                    >
                        {isLoading ? (
                            ...
                            <div className={styles["course-price-container"]}>
                                ...
                                <button className={styles["buy-now-btn"]} onClick={() => handleBuyNow(courseDetail)}>
                                    Mua ngay
                                </button>
