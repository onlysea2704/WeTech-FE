...
const RegisterPayment = () => {
    ...
    return (
        <div>
            <Navbar />
            <div className={styles.registerPaymentMain}>
                <Breadcrumb
                    items={[
                        ...
                        {status === "edit" ? (
                            <div>
                                ...
                                <div className={styles.formRow}>
                                    <div
                                        style={{ width: "100%" }}
                                        className={`${styles.formRowBox} ${styles.fullNameBox}`}
                                    >
                                    ...
                                    <div
                                        style={{ width: "100%" }}
                                        className={`${styles.formRowBox} ${styles.emailBox}`}
                                    >
