...
const CATEGORIES = [
    { label: 'Thành lập Công ty', value: 'dich_vu_thanh_lap_cong_ty' },
    { label: 'Cập nhật thay đổi', value: 'dich_vu_cap_nhat_thay_doi' },
        ...
        <div className={styles.procedureCard} onClick={onClick}>
            ...
            <div className={styles.cardBody}>
                <p className={styles.cardCategory}>
                    {procedure.typeCompanyTitle || procedure.serviceTypeTitle || '—'}
                </p>
                                            ...
                                            <div className={styles["procedures-grid"]}>
                                                {items.map((p) => (
                                                    <ProcedureCard
                                                        ...
                                                        procedure={p}
                                                        onClick={() =>
                                                            navigate(`/process-procedure/${p.procedureId}`)
                                                        }
                                                    />
                                                ))}
                                            </div>
