...
export default function CoDongNhaDauTuNuocNgoaiSection({ dataJson, styles }) {
    return (
        <div className={styles.sectionGroup}>
            <h3 className={styles.sectionTitle}>Cổ đông là nhà đầu tư nước ngoài</h3>
            ...
            <p className={styles.sectionTitle} style={{ marginTop: "16px", marginBottom: "8px" }}>
                ...
                <span style={{ fontStyle: "italic", fontWeight: "normal" }}>
                    (kê khai trong trường hợp cổ đông là nhà đầu tư nước ngoài được cấp Giấy chứng nhận đăng ký đầu tư
            ...
            <div className={styles.formGroup}>
                ...
                <input type="text" className={styles.input} name="maSoDuAn" defaultValue={dataJson?.maSoDuAn || ""} />
            </div>

            <div className={styles.grid2}>
                <div className={styles.formGroup}>
                    <label className={styles.label}>Ngày cấp:</label>
                    <DateInput name="ngayCapDuAn" defaultValue={dataJson?.ngayCapDuAn || ""} className={styles.input} />
                </div>
                <div className={styles.formGroup}>
