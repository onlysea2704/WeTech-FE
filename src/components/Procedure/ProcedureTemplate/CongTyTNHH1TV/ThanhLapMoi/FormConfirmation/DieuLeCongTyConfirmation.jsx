    ...
    return (
        <div className={styles.documentContainer}>
            <div className={styles.header}>
                ...
                <p className={styles.bold}>Độc lập - Tự do - Hạnh phúc</p>
                <br />
            ...
            <p>
                <strong>1. CÔNG TY TNHH {dataJson.tenCongTyVN?.toUpperCase() || ".............................."} </strong>thuộc hình thức Công ty trách nhiệm hữu hạn một thành viên và thuộc sở hữu của cá nhân Ông/Bà <strong>{dataJson.chuSoHuu_hoTen || ".............................."}</strong>
            </p>
            ...
            <p>Tên công ty viết bằng tiếng Việt (<em>ghi bằng chữ in hoa</em>): <strong>{dataJson.tenCongTyVN?.toUpperCase() || "................................................"}</strong></p>
            <p>Tên công ty viết bằng tiếng nước ngoài (<em>nếu có</em>): <strong>{dataJson.tenCongTyEN || "................................................"}</strong></p>
            <p>Tên công ty viết tắt (<em>nếu có</em>): <strong>{dataJson.tenCongTyVietTat || "................................................"}</strong></p>

            <p><strong>2. Địa chỉ trụ sở chính:</strong></p>
            <p><strong>{dataJson.diaChiTruSo || "........................................................................"}</strong></p>
            <p>Điện thoại: <strong>{dataJson.dienThoai || "..................."}</strong> Số fax (<em>nếu có</em>): <strong>{dataJson.fax || "..................."}</strong></p>
            <p>Thư điện tử (<em>nếu có</em>): <strong>{dataJson.email || "..................."}</strong> Website (<em>nếu có</em>): <strong>{dataJson.website || "..................."}</strong></p>
            ...
            <div className={styles.flexRow}>
                <p><strong>Họ và tên: {dataJson.chuSoHuu_hoTen || "........................................."}</strong></p>
                <p>Giới tính: <strong>{dataJson.chuSoHuu_gioiTinh || ".........."}</strong></p>
            </div>
            <div className={styles.flexRow}>
                <p>Sinh ngày: <strong>{formatDate(dataJson.chuSoHuu_ngaySinh) || "....................."}</strong></p>
                <p>Dân tộc: <strong>{dataJson.chuSoHuu_danToc || "Kinh"}</strong></p>
                <p>Quốc tịch: <strong>{dataJson.chuSoHuu_quocTich || "Việt Nam"}</strong></p>
            </div>
            <p>Số định danh cá nhân: <strong>{dataJson.chuSoHuu_cccd || ".........................................................."}</strong></p>
            <p>Địa chỉ liên lạc: <strong>{dataJson.chuSoHuu_diaChi || ".........................................................."}</strong></p>

            <p className={styles.articleTitle}>Điều 5: Vốn điều lệ và thay đổi vốn điều lệ</p>
            <p>1. Vốn điều lệ: </p>
            <p>- Vốn bằng tiền mặt: <strong>{dataJson.vonTienMat || "................................................."} VNĐ</strong></p>
            ...
            <div className={styles.flexRow}>
                <p><strong>Họ và tên: {dataJson.nguoiDaiDien_hoTen || "........................................."}</strong></p>
                <p>Giới tính: <strong>{dataJson.nguoiDaiDien_gioiTinh || ".........."}</strong></p>
            </div>
            <div className={styles.flexRow}>
                <p>Sinh ngày: <strong>{formatDate(dataJson.nguoiDaiDien_ngaySinh) || "....................."}</strong></p>
                <p>Dân tộc: <strong>{dataJson.nguoiDaiDien_danToc || "Kinh"}</strong></p>
                <p>Quốc tịch: <strong>{dataJson.nguoiDaiDien_quocTich || "Việt Nam"}</strong></p>
            </div>
            <p>Số định danh cá nhân: <strong>{dataJson.nguoiDaiDien_cccd || ".........................................................."}</strong></p>
            <p>Địa chỉ liên lạc: <strong>{dataJson.nguoiDaiDien_diaChi || ".........................................................."}</strong></p>
            <p><strong>Chức danh: {dataJson.nguoiDaiDien_chucDanh || "Giám đốc"}</strong></p>

            <p><strong>2. Quyền và nghĩa vụ của người đại diện theo pháp luật.</strong></p>
            <p>Người đại diện theo pháp luật của doanh nghiệp là cá nhân đại diện cho doanh nghiệp thực hiện các quyền và nghĩa vụ phát sinh từ giao dịch của doanh nghiệp, đại diện cho doanh nghiệp với tư cách là người yêu cầu giải quyết dân sự, nguyên đơn, bị đơn, người có quyền lợi, nghĩa vụ liên quan trước Trọng tài, Tòa án và các quyền và nghĩa vụ khác theo quy định của pháp luật. Người đại diện theo pháp luật của doanh nghiệp phải chịu liên đới với các thiệt hại gây ra cho doanh nghiệp theo quy định của pháp luật... </p>
            <p>Người đại diện theo pháp luật của công ty phải cư trú ở Việt Nam và phải ủy quyền bằng văn bản cho người khác thực hiện quyền và nghĩa vụ của người đại diện theo pháp luật khi xuất cảnh khỏi Việt Nam.</p>

            <p><strong>3. Trách nhiệm của người đại diện theo pháp luật.</strong></p>
            <p>a) Thực hiện các quyền và nghĩa vụ được giao một cách trung thực, cẩn trọng, tốt nhất nhằm bảo đảm lợi ích hợp pháp của doanh nghiệp;<br/>b) Trung thành với lợi ích của doanh nghiệp; không sử dụng thông tin, bí quyết, cơ hội kinh doanh của doanh nghiệp, không lạm dụng địa vị, chức vụ và sử dụng tài sản của doanh nghiệp để tư lợi hoặc phục vụ lợi ích của tổ chức, cá nhân khác;<br/>c) Thông báo kịp thời, đầy đủ, chính xác cho doanh nghiệp về việc người đại diện đó và người có liên quan của họ làm chủ hoặc có cổ phần, phần vốn góp chi phối tại các doanh nghiệp khác.</p>

            <p className={styles.articleTitle}>Điều 11: Chủ tịch công ty</p>
            <p>1. Chủ sở hữu công ty là Chủ tịch công ty. Chủ tịch công ty nhân danh chủ sở hữu thực hiện các quyền và nghĩa vụ của chủ sở hữu công ty; nhân danh công ty thực hiện các quyền và nghĩa vụ của công ty, trừ quyền và nghĩa vụ của Giám đốc; chịu trách nhiệm trước pháp luật và chủ sở hữu công ty về việc thực hiện các quyền và nghĩa vụ được giao theo quy định của pháp luật liên quan và Điều lệ công ty.<br/>2. Quyền, nghĩa vụ và chế độ làm việc của Chủ tịch công ty đối với chủ sở hữu công ty được thực hiện theo quy định tại Điều lệ công ty và pháp luật liên quan.<br/>3. Quyết định của Chủ tịch công ty về thực hiện quyền và nghĩa vụ của chủ sở hữu công ty có hiệu lực kể từ ngày được chủ sở hữu công ty phê duyệt, trừ trường hợp Điều lệ công ty có quy định khác.</p>

            <p className={styles.articleTitle}>Điều 12: Giám đốc Công ty </p>
            <p>1. Giám đốc phải có các tiêu chuẩn và điều kiện sau đây: a) Có đủ năng lực hành vi dân sự và không thuộc đối tượng không được quản lý doanh nghiệp; b) Có trình độ chuyên môn, kinh nghiệm trong quản trị kinh doanh của công ty.<br/>2. Giám đốc công ty điều hành hoạt động kinh doanh hằng ngày của công ty. Giám đốc chịu trách nhiệm trước pháp luật và Chủ tịch công ty về việc thực hiện quyền và nghĩa vụ của mình.</p>

            <p className={styles.articleTitle}>Điều 13: Trách nhiệm của chủ tịch công ty, giám đốc </p>
            <p>1. Tuân thủ pháp luật, Điều lệ công ty, quyết định của chủ sở hữu công ty trong việc thực hiện các quyền và nghĩa vụ được giao.<br/>2. Thực hiện các quyền và nghĩa vụ được giao một cách trung thực, cẩn trọng, tốt nhất nhằm bảo đảm lợi ích hợp pháp tối đa của công ty và chủ sở hữu công ty.<br/>3. Trung thành với lợi ích của công ty và chủ sở hữu công ty; không sử dụng thông tin, bí quyết, cơ hội kinh doanh của công ty, lạm dụng địa vị, chức vụ và sử dụng tài sản của công ty để tư lợi hoặc phục vụ lợi ích của tổ chức, cá nhân khác.<br/>4. Thông báo kịp thời...<br/>5. Quyền và nghĩa vụ khác theo quy định...</p>
            ...
            <p>21.1. Hằng năm, sau khi thực hiện nghĩa vụ tài chính với Nhà nước, công ty trích từ lợi nhuận sau thuế để lập các quỹ sau đây:<br/>- Quỹ dự trữ bổ sung vốn điều lệ: 5%<br/>- Quỹ phát triển sản xuất kinh doanh: 10%<br/>- Quỹ khen thưởng phúc lợi: 5%<br/>- Các quỹ khác theo quy định của pháp luật.<br/>21.2. Các quỹ khác sẽ do Chủ tịch Công ty quyết định tùy thuộc vào tình hình kinh doanh và phù hợp với các quy định của pháp luật.<br/>21.3. Chủ sở hữu Công ty chỉ được rút lợi nhuận của Công ty khi Công ty thanh toán đủ các khoản và các nghĩa vụ tài sản khác đến hạn phải trả trong trường hợp công ty bị lỗ trong kinh doanh.<br/>21.4. Xử lý lỗ trong kinh doanh: Trường hợp nếu có hoạt động kinh doanh bị lỗ thì được bù trừ số lỗ vào thu nhập chịu thuế của các hoạt động kinh doanh có thu nhập. Phần thu nhập còn lại sau khi bù trừ áp dụng mức thuế suất thuế thu nhập doanh nghiệp của hoạt động kinh doanh còn thu nhập.</p>
            ...
            <p>1. Tranh chấp nội bộ, Công ty có thể giải quyết trên phương thức tự thỏa thuận nội bộ, nếu không được sẽ thông qua cơ quan pháp luật có thẩm quyền.<br/>2. Tranh chấp bên ngoài, Công ty có quyền bình đẳng trước pháp luật với mọi pháp nhân, thể nhân khi có tố tụng tranh chấp. Đại diện hợp pháp của công ty sẽ đại diện cho công ty trước pháp luật.</p>

            <p className={styles.articleTitle}>Điều 23: Giải thể công ty</p>
            <p>Công ty giải thể trong các trường hợp sau:<br/>1. Theo quyết định của chủ sở hữu;<br/>2. Bị thu hồi Giấy chứng nhận đăng ký doanh nghiệp.</p>

            <p className={styles.articleTitle}>Điều 24: Thủ tục giải thể và thanh lý tài sản</p>
            <p>Việc giải thể và thanh lý tài sản được tiến hành theo các quy định của pháp luật hiện hành và các nguyên tắc xử lý khoản nợ, thanh toán các bộ phần phù hợp với Luật Doanh nghiệp.</p>
            ...
            <p>Điều lệ này được áp dụng cho <strong>CÔNG TY TNHH {dataJson.tenCongTyVN?.toUpperCase() || ".............................."}</strong>. Mọi nhân viên trong công ty có trách nhiệm thi hành nghiêm chỉnh điều lệ này.</p>
            ...
            <p>Điều lệ này gồm 05 (năm) chương, 28 (hai tám) điều và đã được công ty thông qua <strong>ngày {dataJson.ngayThongQua ? formatDate(dataJson.ngayThongQua) : ".... tháng .... năm .... "}</strong>. Điều lệ này có hiệu lực kể từ ngày được Chủ sở hữu công ty thông qua.</p>
            ...
            <div className={styles.signatures}>
                <div className={styles.signatureBox}>
                    ...
                    <p className={styles.signatureName}>
                        {dataJson.chuSoHuu_hoTen ? dataJson.chuSoHuu_hoTen.toUpperCase() : "(Ký, ghi rõ họ tên)"}
                    </p>
                </div>
                <div className={styles.signatureBox}>
                    ...
                    <p className={styles.signatureName}>
                        {dataJson.nguoiDaiDien_hoTen ? dataJson.nguoiDaiDien_hoTen.toUpperCase() : "(Ký, ghi rõ họ tên)"}
                    </p>
                </div>
            </div>
        </div>
