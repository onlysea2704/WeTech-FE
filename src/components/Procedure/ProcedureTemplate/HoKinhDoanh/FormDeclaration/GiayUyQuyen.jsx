                ...
                <div className={styles.colLeft}>
                    ...
                    <div className={styles.grid2}>
                        ...
                        <div className={styles.formGroup}>
                            ...
                            <input type="date" className={styles.input} name="uyQuyen_ngaySinh" defaultValue={dataJson?.uyQuyen_ngaySinh || ''} required />
                        </div>

                        <div className={styles.formGroup}>
                            <label className={styles.label}>Giới tính <span className={styles.required}>*</span></label>
                            <select className={styles.select} name="uyQuyen_gioiTinh" defaultValue={dataJson?.uyQuyen_gioiTinh || ''} required>
                        ...
                        <div className={styles.formGroup}>
                            ...
                            <input type="text" className={styles.input} name="uyQuyen_cccd" defaultValue={dataJson?.uyQuyen_cccd || ''} required pattern="[0-9]{9,12}" title="Số CCCD phải có 9–12 chữ số" />
                        </div>
                    ...
                    <h3 className={styles.sectionTitle} style={{ marginTop: '16px' }}>Địa chỉ liên lạc:</h3>
                    <AddressSelect
                        provinces={provinces}
