...
function isNganhNgheEmpty(row) {
    return !row.tenNganh && !row.chiTiet && !row.maNganh;
}
...
const GiayDeNghi = forwardRef(function GiayDeNghi({ formId, dataJson, onSubmit, formRef }, componentRef) {
    ...
    const handleAddNganh = () => {
        setEditingNganhIdx("new");
        setEditingNganh({ ...EMPTY_NGANH_NGHE });
        setEditingNganhPath([]);
    };
    ...
    const handleAddTV = () => {
        setEditingTVIdx("new");
        setEditingTV({ ...EMPTY_THANH_VIEN });
    };
    const handleEditTV = (idx) => {
        setEditingTVIdx(idx);
        setEditingTV({ ...thanhVienRows[idx] });
    };
    const handleSaveTV = () => {
    ...
    return (
        <form onSubmit={handleSubmit} ref={formRef} key={dataJson ? "loaded" : "empty"}>
                    ...
                    <div className={styles.grid2}>
                        ...
                        <div className={styles.formGroup}>
                            ...
                            <select
                                ...
                                defaultValue={dataJson?.nguoiDaiDien_gioiTinh || ""}
                                required
                            >
                        ...
                        <div className={styles.formGroup}>
                            <label className={styles.label}>
                                Dân tộc <span className={styles.required}>*</span>
                            </label>
                            <select
                                className={styles.select}
                                name="nguoiDaiDien_danToc"
                                defaultValue={dataJson?.nguoiDaiDien_danToc || ""}
                                required
                            >
                                <option value="" disabled>
                                    --Chọn dân tộc--
                        ...
                        <div className={styles.formGroup}>
                            ...
                            <select
                                ...
                                defaultValue={dataJson?.nguoiDaiDien_quocTich || ""}
                                required
                            >
                                <option value="" disabled>
                                    --Chọn quốc tịch--
                                    ...
                                    <tr key={idx}>
                                        ...
                                        <td>
                                            <input
                                                ...
                                                value={editingNganh.chiTiet}
                                                onChange={(e) =>
                                                    setEditingNganh((p) => ({ ...p, chiTiet: e.target.value }))
                                                }
                                            />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input
                                                ...
                                                checked={editingNganh.laNganhChinh}
                                                onChange={(e) =>
                                                    setEditingNganh((p) => ({ ...p, laNganhChinh: e.target.checked }))
                                                }
                                            />
                                        </td>
                                        <td>
                                            <button
                                                ...
                                                disabled={isNganhNgheEmpty(editingNganh)}
                                            >
                                                Lưu
                                            </button>
                                        </td>
            ...
            <div className={styles.formGroup}>
                ...
                <div className={styles.inputWithSuffixKinhGui}>
                    ...
                    <input
                        ...
                        name="kinhGui"
                        defaultValue={
                            dataJson?.kinhGui?.toLowerCase().includes("phường")
                                ? dataJson.kinhGui.substring(dataJson.kinhGui.toLowerCase().lastIndexOf("phường") + 7).trim()
                                : dataJson?.kinhGui || ""
                        }
                    />
                </div>
            ...
            <div className={styles.sectionGroup} style={{ marginTop: "20px" }}>
                ...
                <div className={styles.actionRow}>
                    <button type="button" className={styles.btnPrimary} onClick={handleAddTV} disabled={isTVEditing}>
                        Thêm dòng
                    </button>
                </div>
                <div className={styles.tableContainer}>
                                ...
                                editingTVIdx === idx ? (
                                    <tr key={idx}>
                                        ...
                                        <td>
                                            <input
                                                className={`${styles.input} ${styles.tableInput}`}
                                                value={editingTV.hoTen}
                                                onChange={(e) => setEditingTV((p) => ({ ...p, hoTen: e.target.value }))}
                                            />
                                        </td>
                                        <td>
                                            <input
                                                type="date"
                                                className={`${styles.input} ${styles.tableInput}`}
                                                value={editingTV.ngaySinh}
                                                onChange={(e) =>
                                                    setEditingTV((p) => ({ ...p, ngaySinh: e.target.value }))
                                                }
                                            />
                                        </td>
                                        <td>
                                            <input
                                                className={`${styles.input} ${styles.tableInput}`}
                                                value={editingTV.cccd}
                                                onChange={(e) => setEditingTV((p) => ({ ...p, cccd: e.target.value }))}
                                            />
                                        </td>
                                        <td>
                                            <select
                                                className={`${styles.select} ${styles.tableInput}`}
                                                value={editingTV.gioiTinh}
                                                onChange={(e) =>
                                                    setEditingTV((p) => ({ ...p, gioiTinh: e.target.value }))
                                                }
                                            >
                                                <option value=""></option>
                                                <option value="Nam">Nam</option>
                                        ...
                                        <td>
                                            <select
                                                className={`${styles.select} ${styles.tableInput}`}
                                                value={editingTV.quocTich}
                                                onChange={(e) =>
                                                    setEditingTV((p) => ({ ...p, quocTich: e.target.value }))
                                                }
                                            >
                                                <option value=""></option>
                                                <option value="Việt Nam">Việt Nam</option>
                                        ...
                                        <td>
                                            <select
                                                className={`${styles.select} ${styles.tableInput}`}
                                                value={editingTV.danToc}
                                                onChange={(e) =>
                                                    setEditingTV((p) => ({ ...p, danToc: e.target.value }))
                                                }
                                            >
                                                <option value=""></option>
                                                <option value="Kinh">Kinh</option>
                                        ...
                                        <td>
                                            <input
                                                className={`${styles.input} ${styles.tableInput}`}
                                                value={editingTV.thuongTru || ""}
                                                onChange={(e) =>
                                                    setEditingTV((p) => ({ ...p, thuongTru: e.target.value }))
                                                }
                                            />
                                        </td>
                                        <td>
                                            <input
                                                className={`${styles.input} ${styles.tableInput}`}
                                                value={editingTV.hienTai || ""}
                                                onChange={(e) =>
                                                    setEditingTV((p) => ({ ...p, hienTai: e.target.value }))
                                                }
                                            />
                                        </td>
                                        <td>
                                            <input
                                                className={`${styles.input} ${styles.tableInput}`}
                                                value={editingTV.chuKy || ""}
                                                onChange={(e) => setEditingTV((p) => ({ ...p, chuKy: e.target.value }))}
                                            />
                                        </td>
                                        <td>
                                            <button
                                                ...
                                                disabled={isThanhVienEmpty(editingTV)}
                                            >
                                                Lưu
                                            </button>
                                        </td>
                                    ...
                                    <tr key={idx}>
                                        <td>{idx + 1}</td>
                                        <td className={styles.tdLeft}>{row.hoTen}</td>
                                        <td>{formatDate(row.ngaySinh)}</td>
                                        <td>{row.cccd}</td>
                                        <td>{row.gioiTinh}</td>
                                        <td>{row.quocTich}</td>
                                        <td>{row.danToc}</td>
                                        <td className={styles.tdLeft}>{row.thuongTru}</td>
                                        <td className={styles.tdLeft}>{row.hienTai}</td>
                                        <td>{row.chuKy}</td>
                                        <td>
                                            <div className={styles.tdActions}>
                                                <button
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input
                                            ...
                                            className={`${styles.input} ${styles.tableInput}`}
                                            value={editingTV.ngaySinh}
                                            onChange={(e) => setEditingTV((p) => ({ ...p, ngaySinh: e.target.value }))}
                                        />
                                    </td>
                                    <td>
                                        <input
                                    ...
                                    <td>
                                        <select
                                            className={`${styles.select} ${styles.tableInput}`}
                                            value={editingTV.gioiTinh}
                                            onChange={(e) => setEditingTV((p) => ({ ...p, gioiTinh: e.target.value }))}
                                        >
                                            <option value=""></option>
                                            <option value="Nam">Nam</option>
                                            <option value="Nữ">Nữ</option>
                                    ...
                                    <td>
                                        <select
                                            className={`${styles.select} ${styles.tableInput}`}
                                            value={editingTV.quocTich}
                                            onChange={(e) => setEditingTV((p) => ({ ...p, quocTich: e.target.value }))}
                                        >
                                            <option value=""></option>
                                            <option value="Việt Nam">Việt Nam</option>
                                        </select>
                                    ...
                                    <td>
                                        <select
                                            className={`${styles.select} ${styles.tableInput}`}
                                            value={editingTV.danToc}
                                            onChange={(e) => setEditingTV((p) => ({ ...p, danToc: e.target.value }))}
                                        >
                                            <option value=""></option>
                                            <option value="Kinh">Kinh</option>
                                            <option value="Tày">Tày</option>
                                    ...
                                    <td>
                                        <input
                                            className={`${styles.input} ${styles.tableInput}`}
                                            value={editingTV.thuongTru || ""}
                                            onChange={(e) => setEditingTV((p) => ({ ...p, thuongTru: e.target.value }))}
                                        />
                                    </td>
                                    <td>
                                        <input
                                            className={`${styles.input} ${styles.tableInput}`}
                                            value={editingTV.hienTai || ""}
                                            onChange={(e) => setEditingTV((p) => ({ ...p, hienTai: e.target.value }))}
                                        />
                                    </td>
                                    <td>
                                        <input
