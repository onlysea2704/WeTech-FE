    ...
    return (
        <div className={styles.page}>
            ...
            <div className={styles.infoLine}>
                ...
                <span className={styles.infoValue} style={{ textTransform: 'uppercase' }}>{nguoiDaiDien_hoTen}</span>
            </div>
            <div className={styles.infoLine}>
            ...
            <div className={styles.checkRow} style={{ marginLeft: '16px', marginTop: '6px' }}>
                <span className={(!truSo_soNha && !truSo_xa && !truSo_tinh) ? styles.checkedBox : styles.uncheckedBox}>{(!truSo_soNha && !truSo_xa && !truSo_tinh) ? 'X' : ''}</span>
            ...
            {vonKinhDoanh_bangChu && (
                <div className={styles.infoLine}>
                    ...
                    <span className={styles.infoValue} style={{ fontStyle: 'italic' }}>{vonKinhDoanh_bangChu}</span>
                </div>
            )}
            ...
            <div className={styles.infoRow} style={{ marginLeft: '16px' }}>
                <div className={styles.checkRow} style={{ marginRight: '40px' }}>
                    <span className={isPPKeKhai ? styles.checkedBox : styles.uncheckedBox}>{isPPKeKhai ? 'X' : ''}</span>
            ...
            <div className={styles.tableContainer}>
                <table className={styles.table} style={{ fontSize: '12px' }}>
                    ...
                    <tbody>
                        {thanhVienList.length > 0 ? thanhVienList.map((row, idx) => (
                            <tr key={idx}>
                                <td>{idx + 1}</td>
                                <td>{row.hoTen}</td>
            ...
            <div className={styles.closingText}>
                <p>- Bản thân đồng ý chia sẻ thông tin cá nhân được lưu giữ tại Cơ sở dữ liệu quốc gia về dân cư cho Cơ quan đăng ký kinh doanh cấp xã, Cơ quan quản lý nhà nước về đăng ký kinh doanh để phục vụ công tác quản lý nhà nước về đăng ký hộ kinh doanh theo quy định;</p>
                <p>- Bản thân không thuộc diện pháp luật cấm kinh doanh; không đồng thời là chủ hộ kinh doanh, thành viên hộ gia đình đăng ký hộ kinh doanh khác; không là chủ doanh nghiệp tư nhân;</p>
                <p>- Trụ sở thuộc quyền sử dụng hợp pháp của hộ kinh doanh và được sử dụng đúng mục đích theo quy định của pháp luật (hộ kinh doanh chỉ cam kết trong trường hợp kinh doanh tại trụ sở);</p>
                <p>- Hoàn toàn chịu trách nhiệm trước pháp luật về tính hợp pháp, chính xác và trung thực của nội dung đăng ký trên.</p>
            </div>
