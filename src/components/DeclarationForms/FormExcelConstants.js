...
export const THANH_VIEN_HEADERS = ['STT', 'Họ tên (*)', 'Ngày sinh (dd/mm/yyyy)', 'Số CCCD', 'Giới tính (Nam/Nữ)', 'Quốc tịch', 'Dân tộc', 'Nơi thường trú', 'Nơi ở hiện tại', 'Chữ ký'];
...
export const SECTION_FIELD_MAP_DENGHI = {
    'NƠI THƯỜNG TRÚ': { 'Tỉnh/Thành phố': 'thuongTru_tinh', 'Xã/Phường': 'thuongTru_xa', 'Số nhà, đường': 'thuongTru_soNha' },
...
export const SECTION_FIELD_MAP_UYQUYEN = {
    'ĐỊA CHỈ LIÊN LẠC': { 'Tỉnh/Thành phố': 'uyQuyen_tinh', 'Xã/Phường': 'uyQuyen_xa', 'Số nhà, đường': 'uyQuyen_soNha' }
};
